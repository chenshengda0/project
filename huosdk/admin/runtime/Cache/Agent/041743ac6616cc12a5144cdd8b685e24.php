		...
		<div class="common-form">
			<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Gm/give_post');?>">
				<fieldset>
					...
					<div class="control-group">
							<label class="control-label">游戏币:</label>
							<div class="controls">
					...
					<div class="control-group">
						<label class="control-label">已有<?php echo ($gamemoneys[$app_id]); ?>数量:</label>
						<div class="controls">
							<input type="text" class="input" name="oldgm" id="oldgm" style="color:blue;" value="<?php echo ($oldgm); ?>" readonly="readonly" >
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">充值<?php echo ($gamemoneys[$app_id]); ?>数量:</label>
						<div class="controls">
							<input type="text" class="input" name="newgm" value="<?php echo ($newgm); ?>" readonly="readonly" autocomplete="off">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="discount" value="<?php echo ($amount*10/$newgm); ?>" readonly="readonly" autocomplete="off">
						</div>
					</div>
