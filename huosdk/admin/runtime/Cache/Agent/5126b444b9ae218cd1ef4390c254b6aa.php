...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="#" target="_self">编辑渠道</a></li>
		</ul>
			<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Agent/edit_post');?>">
				<fieldset>
					<div class="control-group">
						<label class="control-label">账号:</label>
						<div class="controls">
							<label class="control-label"  style="text-align:left"><?php echo ($user_login); ?></label>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="linkman" value="<?php echo ($linkman); ?>">
						</div>
					</div>
					...
					<div class="control-group" >
						...
						<div class="controls">
							<input type="text" class="input" name="qq" value="<?php echo ($qq); ?>">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php if(is_array($roles)): foreach($roles as $k=>$vo): ?><label class="checkbox inline">
								<?php $role_id_checked=$user_type==$k?"checked":""; ?>
								<input value="<?php echo ($k); ?>" type="radio" name="role_id" <?php echo ($role_id_checked); ?>><?php echo ($vo); ?>
