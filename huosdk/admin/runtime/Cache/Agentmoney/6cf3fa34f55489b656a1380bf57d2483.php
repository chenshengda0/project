...
<body class="J_scroll_fixed">
	<div class="wrap js-check-wrap">
		<form class="well form-search" method="post" action="<?php echo U('Gmmem/index');?>">
		...
		<form class="js-ajax-form" action="" method="post">
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($items)): foreach($items as $key=>$vo): ?><tr>
					...
					<td>
						<a href="<?php echo U('Agentmoney/Gm/givenogame',array('mem_id'=>$vo['mem_id']));?>">发放</a> 
						<a href="<?php echo U('Agentmoney/Gmmem/charge',array('app_id'=>$vo['app_id'],'mem_id'=>$vo['mem_id']));?>">  | 发放记录</a></td>
					</td>
