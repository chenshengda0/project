...
<body class="J_scroll_fixed">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Gm/give');?>">游戏币转账</a></li>
		</ul>
			...
			<form method="post" class="form-horizontal" action="<?php echo U('Gm/give_verify');?>">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="remain" id="remain" style="color:blue;" value="<?php echo ($remain); ?>" readonly="readonly" >
						</div>
					</div>
