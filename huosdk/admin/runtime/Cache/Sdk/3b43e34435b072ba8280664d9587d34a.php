...
<body>
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Subpackage/qudaoindex');?>">一键分包</a></li>
			<li class="active"><a href="#" target="_self">添加渠道</a></li>
		</ul>
			<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Subpackage/addagent_post');?>">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="user_pass" value="" placeholder="输入密码">
						</div>
					</div>
					<div class="control-group">
				...
				<button type="submit" class="btn btn-primary js-ajax-submit"><?php echo L('ADD');?></button>
					<a class="btn" href="<?php echo U('Subpackage/qudaoindex');?>">返回</a>
				</div>
			</form>
	</div>
