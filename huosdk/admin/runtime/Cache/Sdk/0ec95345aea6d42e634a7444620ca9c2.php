...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Sdk/Game/add');?>">添加游戏</a></li>
		</ul>
	
	<div class="wrap jj">
		<div class="common-form">
			<div id="kv-avatar-errors" class="center-block" style="width:800px;display:none"></div>
			<form enctype="multipart/form-data"  class="form-horizontal js-ajax-form" action="<?php echo U('Sdk/Game/add_post');?>" method="post"> 
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php if(is_array($gamestatues)): foreach($gamestatues as $k=>$v): $gs_select=$k==1 ?"checked":""; ?>
								<label class="radio inline" for="active_true">
