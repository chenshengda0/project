...
<body class="J_scroll_fixed">
	<div class="wrap js-check-wrap">
		<form class="well form-search" method="get" action="<?php echo U('Agent/marketindex');?>">		 			 
			<div class="search_type cc mb10">			
				<div class="mb10">
				渠道账号： 					
					<select class="select_2" name="agent_id" id="selected_id">
							<?php if(is_array($agents)): foreach($agents as $k=>$vo): $aid_select=$k==$formget['agent_id']?"selected":""; ?>
							<option value="<?php echo ($k); ?>"<?php echo ($aid_select); ?>><?php echo ($vo); ?></option><?php endforeach; endif; ?>
					    </select>
		...
		<form class="js-ajax-form" action="" method="get">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if( 1 == $current_page AND !empty($todaypays['date'])): ?><tr>
						...
						<td><?php echo ($agents[$todaypays['agent_id']]); ?></td>
