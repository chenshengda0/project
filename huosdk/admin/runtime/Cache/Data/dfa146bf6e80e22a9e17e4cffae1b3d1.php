...
<body class="J_scroll_fixed">
	<div class="wrap js-check-wrap">
		<form class="well form-search" method="get" action="<?php echo U('Data/Pay/index');?>">
			<div class="search_type cc mb10">
				<div class="mb10">
					<span class="mr20">
						...
						<input type="text" name="end_time" class="js-date"  value="<?php echo ((isset($formget['end_time']) && ($formget['end_time'] !== ""))?($formget['end_time']):''); ?>" style="width: 100px;" autocomplete="off"> &nbsp; &nbsp;
						<input type="submit" class="btn btn-warning" name='date_time' value="搜索" />
						<input type="submit" class="btn btn-warning" name='date_time' value="今日" />
		...
		<form class="js-ajax-form" action="" method="get">
			<table class="table table-hover table-bordered table-list">
				<thead>
					...
					<?php if( (1 == $current_page OR 0 == $current_page) AND !empty($todaypays['date'])): ?><tr>
