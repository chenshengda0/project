...
{//类定义开始
     ...
     * @param string $function 操作
     * @param string $ip       ip信息
     +----------------------------------------------------------
     * @return true or false
     +----------------------------------------------------------
     */
    static function write_in_db ($db, $message, $model, $function, $ip, $website, $operator)
    {
        $call_info = array_shift(debug_backtrace());
        $code_line = $call_info['line'];
        $sql = 'INSERT INTO wy_product.product_logs (l_message,l_model,l_function,l_codeline,l_ip,create_time,website,operator) VALUES ("'.$message.'","'.$model.'","'.$function.'",'.$code_line.',"'.$ip.'",'.time().',"'.$website.'",'.$operator.')';
        $db->query($sql);
    }
}
?>