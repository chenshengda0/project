    ...
    public function _import($attr,$content,$isFile=false,$type='')
    {
        ...
        if($isFile) {
            ...
            foreach ($array as $val){
                switch($type) {
                case 'js':
                    $parseStr .= '<script type="text/javascript" src="'.$val.'" charset="utf-8"></script>';
                    break;
                case 'css':
            ...
            foreach ($array as $val){
                switch($type) {
                case 'js':
                    $parseStr .= "<script type='text/javascript' src='".$basepath.'/'.str_replace(array('.','#'), array('/','.'),$val).'.js'."' charset='utf-8'></script> ";
                    break;
                case 'css':
