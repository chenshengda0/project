...
<div id="middle">
	<div class="content mt">
			...
			<div class="kefu_r">
					<div class="help_r_nav">注册的常见问题
		</div>
					<div class="kefu_box">
					  	<div class="help_r_main">
		  <div class="help_r_main_t">注册的常见问题</div>
		  <div class="help_r_main_word">
		  <p>1、点击网页上方的【立即注册】按钮；</p>
		  <p>2、在注册页面依次输入账号、密码、确认密码，用于保护账号安全的密保手机跟密保邮箱。保证填写信息的正确性有助于账号的安全保护；</p>
		  <p>3、进入个人中心，填写更多的个人信息；</p>
		  <p>4、官网注册的账号，在我司平台的游戏中均可登陆。</p>
		</div>
		</div>
					</div>
			</div>
