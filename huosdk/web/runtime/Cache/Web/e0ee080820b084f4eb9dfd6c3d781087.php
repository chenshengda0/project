...
<div class="gg_game">
	...
	<div id="banner_game" class="ntn">
		<div class="ggs1">
			<div class="ggBox1">
				<a href="<?php echo ($guanggao["url"]); ?>" target="_blank"><img width="20%" height="250px" style="background-size:cover;"  src="/upload//image/<?php echo ($guanggao["img"]); ?>" alt="<?php echo ($guanggao["title"]); ?>"></a>
			</div>
		</div>
	</div>
</div>
<div id="middle">
	<div class="content mt">
		<div class="contp">
			<div class="contp_tit">
				<ul id="tags">
					<li class="selectTag"><a style="color:#e55f06;" href="<?php echo U('Web/New/index');?>">资讯中心</a></li>
				</ul>
			</div>
			<div id="tagContent0" class="tagContent selectTag">
				<div class="n_box">
					<ul>
						<?php if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><!--img width="143" height="104" src="/upload//image/<?php echo ($newslist[i]["image"]); ?>"--><h2>
							<?php if($vo['html'] == 1): ?><a href="" title="<?php echo ($vo["title"]); ?>" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["title"]); ?></a>
							<?php else: ?>
								<a href="<?php echo U('Web/New/Index',array('show'=>'display','newsid'=>$vo['id']));?>" title="  <?php echo ($vo["title"]); ?>" target="_blank">&nbsp;&nbsp;<?php echo ($vo["title"]); ?></a><?php endif; ?>
								<span><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></span></h2>
								<p> &nbsp&nbsp&nbsp&nbsp<?php echo ($vo["content"]); ?></p>
