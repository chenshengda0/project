...
<div id="middle">
	<div class="content mt">
			...
			<div class="kefu_r">
					<div class="help_r_nav">如何设置密保
		</div>
					<div class="kefu_box">
					  	<div class="help_r_main">
		  <div class="help_r_main_t">
		    <p>如何设置密保</p>
		  </div>
		  <div class="help_r_main_word">
		  <p>1、设置密保必须先登录您的账号，进入个人中心；</p>
		  <p>2、在【设置密保】菜单中，选择密保提示问题，总共三个必选问题，依次填入密保答案；为保障账号安全，建议您记录您的密保问题及答案。点击【确认】，密保及设置成功；</p>
		  <p>3、再次进入【设置密保】菜单，需输入正确的密保信息，以保障您账号的安全性。</p>
