...
<div id="header">
	...
	<div class="gg_game">
		...
		<div id="banner_game" class="ntn">
				<div class="ggs1">
				<div class="ggBox1">
				<a href="#" target="_blank"><img src="/public/web/images/game_1.jpg"></a>
				</div>
				</div>
		</div>
</div>
<div id="middle">
	<div class="content mt">
		<div class="contp">
	     ...
	     <div class="news_detail_title"><?php echo ($newsinfo["title"]); ?></div>
		 <div class="news_detail_title_nav"><?php echo (date("Y-m-d H:i:s",$newsinfo["create_time"])); ?> <script> document.write(parseInt(1000*Math.random())); </script>次</div>
		 <div class="news_detail_fx">
		 	
			</div>
		 <div class="news_detail_line"></div>
		 <div class="news_detail_text">
		  <p>
	</p><p></p><p><?php echo ($contentdata["content"]); ?></p>
<p></p>
<p></p>
		 </div>
		 <div class="news_detail_xg">
		   <ul>
